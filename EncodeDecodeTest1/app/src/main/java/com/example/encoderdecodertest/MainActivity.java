...
public class MainActivity extends Activity implements SurfaceHolder.Callback{
    ...
    private static class BufferToSurfaceWrapper implements Runnable {
        ...
        private BufferToSurfaceWrapper(MainActivity test) {
            mTest = test;
        }
    ...
    private static class BufferToSurfaceWrapper1 implements Runnable {
        ...
        private BufferToSurfaceWrapper1(MainActivity test) {
            mTest = test;
        }
    ...
    public void onClick (View view) {
        Intent newIntent = new Intent (this, ParallelOperations.class);
